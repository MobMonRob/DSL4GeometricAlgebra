...
| lineopns(tuple3d, weight, tuple3d, weight), lineopns(tuple3d, tuple3d) | creates a conformal line in OPNS representation, from a tuple3d representing an euclidean point and an other tuple3d representing a direction or a second point, with given weights or implicit with weight==1. | new CGALineOPNS(new CGARoundPointIPNS(new CGAE3Vector(Tuple3d p1, double weight1), new CGARoundPointIPNS(new CGAE3Vector(Tuple3d p2. double weight2)) |
