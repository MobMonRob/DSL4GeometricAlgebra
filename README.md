...
| :--------: | :------: | ---------------- | ------- | ----------- | -------------- | :----- |
| 3          | &#x2229; | \cap             | \u2229  | join (intersection) | multivector1.meet(multivector2) | \& |
| 3          | &#x222A; | \cup             | \u222A  | meet  (union) | multivector1.join(multivector2) or multivector2* &#8901; multivector1 or (multivector2* &#8743; multivector1*)* | \| |
