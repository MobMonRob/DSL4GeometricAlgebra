...
| 3 | &#8901;   | \cdot | \u22C5 | inner product | multivector1.ip(multivector2, RIGHT_CONTRACTION) | In the default configuration equal to left contraction. But this looks to be incompatible with some formulas in [Kleppe] which work only with the usage of right contraction. |
