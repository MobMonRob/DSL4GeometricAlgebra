...
| precedence | symbol | latex | unicode | description | implementation | hints |
| :--------: | :----: | ------- | ----- | ----------- | -------------- | :----- |
...
| 2 | &#47;  | \StrikingThrough | \u002F | division (inverse geometric product) | multivector1.div(multivector2), double.div(double) | In CLUscript the corresponding symbol is "|" |
