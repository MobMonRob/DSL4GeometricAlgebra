...
| tangentbivector_opns(point1, weight1, direction, weight2), tangentbivector_opns(point1, weight1, direction, weight2)  | creates a tangent bivector in OPNS representation, based on a point and a direction | new CGATangentBivector(new CGAE3Vector(Tuple3d point), new CGAScalarVector(double weight1), new CGAE3Vector(Tuple3d direction), new CGAScalar(double weight2)) |
