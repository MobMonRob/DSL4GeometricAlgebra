...
| :------------------------------------------------- | ----------- | -------------- |
| point(tuple3d, weight), point(tuple3d)             | creates a conformal point from a tuple3d in IPNS representation, with a given weight or implicit with weight==1d. | new CGARoundPointIPNS(new CGAE3Vector(Tuple3d p), new CGAScalar(double weight) |
| pointpair(tuple3d, weight, tuple3d, weight), pointpair(tuple3d, tuple3d)     | creates a conformal point pair in IPNS representation from two tuple3d objects, with given weights or implicit with weight==1.| new CGAOrientedPointPair(new CGAE3Vector(Tuple3d p1),  new CGAScalar(double weight1), new CGAE3Vector(Tuple3d p2), new CGAScalar(double weight2) |
