...
This algebra contains flat objects only. The dual operator is defined by the Hodge Dual. Using the euclidean split it admits the closed form expression $\widetilde{A_E}E_3+\epsilon_0\widehat{\widetilde{A_I}}E_3$ with $A_E=idle(A), A_I=euclid(A) $
