...
public class CasadiFuncTransform extends GeomAlgeParserBaseListener {
	...
	protected CasadiFuncTransform(Map<String, FunctionSymbolic> functionsView) {
	...
	public static FunctionSymbolic generate(GeomAlgeParser.FunctionContext ctx, Map<String, FunctionSymbolic> functionsView) {
		CasadiFuncTransform transform = new CasadiFuncTransform(functionsView);
	...
	public void enterAssgnStmt(GeomAlgeParser.AssgnStmtContext ctx) {
		MultivectorSymbolic expr = CasadiExprTransform.generateExprAST(ctx.exprContext, this.functionsView, this.localVariablesView);
	...
	public void enterRetExprStmt(GeomAlgeParser.RetExprStmtContext ctx) {
		MultivectorSymbolic retExpr = CasadiExprTransform.generateExprAST(ctx.exprContext, this.functionsView, this.localVariablesView);
