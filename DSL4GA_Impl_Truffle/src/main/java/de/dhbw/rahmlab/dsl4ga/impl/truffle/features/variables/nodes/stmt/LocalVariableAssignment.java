...
public abstract class LocalVariableAssignment extends NonReturningStatementBaseNode {
	...
	@Specialization
	protected void doExecute(VirtualFrame frame, MultivectorSymbolic exprValue, @Cached(value = "currentLanguageContext()", neverDefault = true) GeomAlgeLangContext context) {
